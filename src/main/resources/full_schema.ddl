create table entry (id  bigserial not null, done_practicing boolean not null, random_order int8, word varchar(32), artikel varchar(3), user_id int8, primary key (id));
...
CREATE SEQUENCE random_order_seq START 1;
